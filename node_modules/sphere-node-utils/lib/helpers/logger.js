...
module.exports = (function() {
  ...
  function _Class(config) {
    var levelFile, levelStream, logger, name, path, ref, serializers, silent, src, streams;
    if (config == null) {
      config = {};
    }
    ref = _.defaults(config, {
      ...
      src: false,
      silent: false
    }), levelStream = ref.levelStream, levelFile = ref.levelFile, path = ref.path, logger = ref.logger, name = ref.name, serializers = ref.serializers, src = ref.src, silent = ref.silent;
    ...
    if (silent) {
      ...
      logger.info = function() {
        return console.info.apply(this, Array.prototype.slice.call(arguments));
      };
      logger.warn = function() {
        return console.warn.apply(this, Array.prototype.slice.call(arguments));
      };
      logger.error = function() {
        return console.error.apply(this, Array.prototype.slice.call(arguments));
      };

...
ProductProjectionService = (function(superClass) {
  ...
  ProductProjectionService.prototype.byKey = function() {};
  ...
  ProductProjectionService.prototype._setDefaults = function() {
    ...
    this._params.encoded = this._params.encoded.concat(['filter', 'filter.query', 'filter.facets', 'facets', 'searchKeywords']);
    return this._params.plain = this._params.plain.concat(['staged', 'fuzzy']);
  };
  ...
  ProductProjectionService.prototype.fuzzy = function(fuzzy) {
    if (fuzzy == null) {
      fuzzy = true;
    }
    this._params.query.fuzzy = fuzzy;
  ...
  ProductProjectionService.prototype._queryString = function() {
    var customQueryString, facet, filter, filterByFacets, filterByQuery, fuzzy, ref, searchKeywords, staged, text;
    ref = _.defaults(this._params.query, {
      ...
      facet: [],
      searchKeywords: []
    }), staged = ref.staged, fuzzy = ref.fuzzy, text = ref.text, filter = ref.filter, filterByQuery = ref.filterByQuery, filterByFacets = ref.filterByFacets, facet = ref.facet, searchKeywords = ref.searchKeywords;
    customQueryString = [];
    if (staged) {
      customQueryString.push("staged=" + staged);
    }
    if (fuzzy) {
      customQueryString.push("fuzzy=" + fuzzy);
    }
    if (text) {

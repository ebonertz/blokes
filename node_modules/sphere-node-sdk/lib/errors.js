/* ===========================================================
# sphere-node-sdk - v1.16.2
# ==============================================================
# Copyright (c) 2016 SPHERE.IO™
# Licensed .
#
#    
*/
var BadRequest, ConcurrentModification, GraphQLError, HttpError, InternalServerError, MethodNotAllowed, NotFound, ServiceUnavailable, SphereError, Unauthorized,
...
HttpError = (function(superClass) {
  ...
  function HttpError(message, body) {
    ...
    if (this.body.statusCode) {
      this.statusCode = this.body.statusCode;
    }
...
GraphQLError = (function(superClass) {
  extend(GraphQLError, superClass);

  function GraphQLError(message, body) {
    this.message = message;
    this.body = body != null ? body : {};
...
MethodNotAllowed = (function(superClass) {
  extend(MethodNotAllowed, superClass);

  function MethodNotAllowed(message, body) {
    this.message = message;
    this.body = body != null ? body : {};

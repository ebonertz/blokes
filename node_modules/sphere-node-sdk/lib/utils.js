...
module.exports = {
  ...
  buildQueryString: function(opts) {
    var expand, limitParam, offsetParam, page, perPage, queryString, ref, sort, where, whereOperator, whereParam;
    if (opts == null) {
      opts = {};
    }
    ref = _.defaults(opts, {
      ...
      sort: [],
      expand: []
    }), where = ref.where, whereOperator = ref.whereOperator, sort = ref.sort, page = ref.page, perPage = ref.perPage, expand = ref.expand;
   ...
   */
  _censorHeaderStr: function(header) {
    return header.replace(/Bearer [\w-]*/, 'Bearer **********');
  },
   ...
   */
  _censorHeaderObj: function(header) {

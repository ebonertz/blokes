...
SphereClient = (function() {
  function SphereClient(options) {
    ...
    if ((options.enableRepeater != null) && !options.enableRepeater) {
      this._task = new TaskQueue;
    } else {
      this._task = options.task || new RepeaterTaskQueue({}, {});
    }

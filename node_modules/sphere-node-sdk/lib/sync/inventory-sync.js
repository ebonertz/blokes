...
InventorySync = (function(superClass) {
  ...
  InventorySync.actionGroups = ['quantity', 'expectedDelivery', 'custom'];
  ...
  InventorySync.prototype._doMapActions = function(diff, new_obj, old_obj) {
    ...
    allActions.push(this._mapActionOrNot('custom', (function(_this) {
      return function() {
        return _this._utils.actionsMapCustom(diff, old_obj, new_obj);
      };
    })(this)));
